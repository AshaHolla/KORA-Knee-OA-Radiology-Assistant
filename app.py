...
if uploaded_file is not None:
    ...
    original_title2 = '<p style="font-family: Franklin Gothic Medium; color:White; font-size: 50px; text-align: left">KORA Diagnosis - Severity Analysis of Knee Osteorthritis </p>'
...
#    Description = ["No features of OA","Minute Osteophyte : Doubtful Significance","Definite Osteophyte : Normal Joint Space","Moderate Joint Space reduction","Joint space greatly reduced : Subchondral Sclerosis"]
    ...
    if(prediction == 0):
        ...
        with col12:    
            ...
            pdf_display = f'<div align="center"><iframe src="data:application/pdf;base64,{base64_pdf}" width="500" height="750" type="application/pdf" ></iframe></div>'
    ...
    if(prediction == 1):
        ...
        with col12: 
            ...
            with open("reports/grade_0.pdf","rb") as f:
                base64_pdf = base64.b64encode(f.read()).decode('utf-8')
            pdf_display = f'<div align="center"><iframe src="data:application/pdf;base64,{base64_pdf}" width="500" height="700" type="application/pdf" align="middle"></iframe></div>'
            st.markdown(pdf_display, unsafe_allow_html=True)
    ...
    original_title2 = '<p style="font-family: Franklin Gothic Medium; color:White; font-size: 60px; text-align: center">Knee OA Radiology Assistant</p>'
    st.markdown(original_title2, unsafe_allow_html=True)
